...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\admin\org.apache.karaf.admin.command\2.2.9\org.apache.karaf.admin.command-2.2.9.jar;%KARAF_HOME%\system\org\apache\karaf\admin\org.apache.karaf.admin.core\2.2.9\org.apache.karaf.admin.core-2.2.9.jar;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.2.9\org.apache.karaf.shell.console-2.2.9.jar;%KARAF_HOME%\system\org\apache\aries\blueprint\org.apache.aries.blueprint\0.3.2\org.apache.aries.blueprint-0.3.2.jar;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api\1.6.9\pax-logging-api-1.6.9.jar;%KARAF_HOME%\system\org\apache\felix\org.apache.felix.framework\3.2.2\org.apache.felix.framework-3.2.2.jar
